...
import { FactoryDashboardLinks } from "@/components/general/FactoryDashboardLinks";
...
export default async function DashboardLayout({
    ...
    if (!hasFactoryDashboardAccess(session.user?.role)) {
        redirect("/api/v1/customerDashboard"); // Redirect to customer dashboard if unauthorized
    }
    return (
        <>
                    ...
                    <div className="flex flex-col max-h-screen h-full gap-2">
                        ...
                        <div className="flex-1">
                            <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                                <FactoryDashboardLinks userRole={session.user?.role as Role} />
                            </nav>
                        </div>
                    </div>
                </div>

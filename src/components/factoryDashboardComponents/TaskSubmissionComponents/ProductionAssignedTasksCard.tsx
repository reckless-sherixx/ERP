...
import { ProductionSubmitWorkDialog } from "./ProductionSubmitWorkDialog";
import { Order } from "@/types/order";

interface ProductionAssignedTasksCardProps {
    initialData: Order[];
}

export function ProductionAssignedTasksCard({ initialData }: ProductionAssignedTasksCardProps) {
